...
def test_display():
    ...
    tile_1 = maps.Tile('F', 'W', 'P', 'F')
    
    tile_base = maps.Tile('F', 'P', 'P', 'F')
    tile_2 = tile_base.rotated(1)
    tile_3 = tile_base.rotated(2)
    tile_4 = tile_base.rotated(3)
    
    tile_map = maps.TileMap(None)
